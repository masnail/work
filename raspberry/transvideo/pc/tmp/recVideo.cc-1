...
//    cout << row << " : " << col << endl;
	...
	for(int i = 0; i < _BUFF_CNT; ++i)
	    _video[i] = Mat::zeros(row, col,  CV_8UC3);
    }
	...
	//uchar *pData = _video[storge_index++].ptr<uchar>(i);
...
//	cout << tmp_index << endl;
	...
	//cout << tmp_index << endl;
	uchar *pData = _video[0].ptr<uchar>(tmp_index);
   ...
   /* if(show_index++)
	...
	imshow("rec",_video[show_index++]);
    }*/

    imshow("recv", _video[0]);
    waitKey(25) ;
    
}

void Recvideo::transEnd()
{
